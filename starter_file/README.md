...
The widget functionality also provides additional insights into the different run. The following two figures indicate how both parameters affected the accuracy:
![plot](https://github.com/nikextens/AzureML_Capstone/blob/master/starter_file/Screenshots/hypertune_accuracy_over_runs.PNG)
![plot](https://github.com/nikextens/AzureML_Capstone/blob/master/starter_file/Screenshots/hypertune_by_params.PNG)
